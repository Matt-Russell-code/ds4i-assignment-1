...
kable(cnn_cm_df, caption = "CNN Statistics by Class", digits = 4) %>%
  kable_styling() %>%
  footnote(general = "All values rounded to 4 decimal places.")
```
...
kable(rnn_cm_df, caption = "RNN Statistics by Class", digits = 4) %>%
  kable_styling() %>%
  footnote(general = "All values rounded to 4 decimal places.")
```
...
kable(ffnn_cm_df, caption = "FFNN-MLP Statistics by Class", digits = 4) %>%
  kable_styling() %>%
  footnote(general = "All values rounded to 4 decimal places.")
```
