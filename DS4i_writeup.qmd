...
The diagonal of the RNN is the weakest of them all. Its correct predictions are concentrated in Low (735) with spillover to Moderate (205), and its misclassifications are concentrated in Low (148) and High (165) predictions which were actually Moderate instances. This tells us the model often confused Moderate cases as either Low (underestimated hazard) or High (overestimated hazard).
