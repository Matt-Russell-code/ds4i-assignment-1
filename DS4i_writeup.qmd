...
ffn_cm_df <- data.frame(
  ...
  Considerable_minus = c(2, 41, 250, 17, 10),
  Considerable_plus  = c(0, 6, 56, 14, 3),
  High               = c(0, 0, 10, 1, 14)
)
...
cnn_cm_df <- data.frame(
  ...
  Considerable_minus = c(18, 60, 4, 32, 0),
  Considerable_plus  = c(8, 18, 3, 9, 0),
  High               = c(0, 0, 0, 0, 0)
)
...
rnn_cm_df <- data.frame(
  ...
  Considerable_minus = c(53, 29, 0, 31, 0),
  Considerable_plus  = c(20, 5, 0, 12, 0),
  High               = c(0, 0, 0, 0, 0)
)
