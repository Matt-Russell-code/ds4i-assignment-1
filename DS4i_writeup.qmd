...
#(rnn_window_30, file =  "rnn_window_30")
#Window = 120
...
rnn_final_search[1,]
#fitting final rnn_mdoel = 64, 16 0.7.  0.5
...
labels_cnn <-  max.col(y.test) #these  are the lables  for  the cnn and rnn (different  train/test)
labels_nn <- test$OAH #these  are the   labels  for  the  FFN
